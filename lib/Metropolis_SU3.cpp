...
template <typename T>
void Metropolis_SU3_4D(const size_t &LX, const size_t &LY, const size_t &LZ,
                       const size_t &LT, const size_t &n_hit, const T &beta,
                       const T &delta, const size_t &seed,
...
template <typename T>
void Metropolis_SU3_2D(const size_t &LX, const size_t &LT, const size_t &n_hit,
...
template void Metropolis_SU3_4D<float>(const size_t &LX, const size_t &LY,
...
template void Metropolis_SU3_4D<double>(const size_t &LX, const size_t &LY,
                                        const size_t &LZ, const size_t &LT,
...
template void Metropolis_SU3_3D<float>(const size_t &LX, const size_t &LY,
                                       const size_t &LT, const size_t &n_hit,
...
template void Metropolis_SU3_3D<double>(const size_t &LX, const size_t &LY,
                                        const size_t &LT, const size_t &n_hit,
...
template void Metropolis_SU3_2D<float>(const size_t &LX, const size_t &LT,
                                       const size_t &n_hit, const float &beta,
                                       const float &delta, const size_t &seed,
                                       const size_t &n_sweep,
                                       const bool cold_start,
...
template void Metropolis_SU3_2D<double>(const size_t &LX, const size_t &LT,
                                        const size_t &n_hit, const double &beta,
                                        const double &delta, const size_t &seed,
                                        const size_t &n_sweep,
                                        const bool cold_start,
