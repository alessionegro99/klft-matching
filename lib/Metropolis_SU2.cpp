...
template <typename T>
void Metropolis_SU2_4D(const size_t &LX, const size_t &LY, const size_t &LZ,
  ...
  std::cout << "Running Metropolis_SU2_4D" << std::endl;
...
void Metropolis_SU2_3D(const size_t &LX, const size_t &LY, const size_t &LT,
  ...
  std::cout << "Running Metropolis_SU2_3D" << std::endl;
  std::cout << "Gauge Field Dimensions:" << std::endl;
  std::cout << "LX = " << LX << std::endl;
  std::cout << "LY = " << LY << std::endl;
  std::cout << "LT = " << LT << std::endl;
...
template <typename T>
void Metropolis_SU2_2D(const size_t &LX, const size_t &LT, const size_t &n_hit,
                       const T &beta, const T &delta, const size_t &seed,
                       const size_t &n_sweep, const bool cold_start,
                       const std::string &outfilename) {
  std::cout << "Running Metropolis_SU2_2D" << std::endl;
  std::cout << "Gauge Field Dimensions:" << std::endl;
  std::cout << "LX = " << LX << std::endl;
  std::cout << "LT = " << LT << std::endl;
  std::cout << "Metropolis Parameters:" << std::endl;
...
template void Metropolis_SU2_4D<float>(const size_t &LX, const size_t &LY,
...
template void Metropolis_SU2_4D<double>(const size_t &LX, const size_t &LY,
                                        const size_t &LZ, const size_t &LT,
...
template void Metropolis_SU2_3D<float>(const size_t &LX, const size_t &LY,
...
template void Metropolis_SU2_3D<double>(const size_t &LX, const size_t &LY,
                                        const size_t &LT, const size_t &n_hit,
